...
static struct list_node *list_checkValid(list_t list)
// MODIFIES: cerr
...
static void list_checkNonEmpty(list_t list)
// MODIFIES: cerr
...
static void list_print_helper(list_t list)
// MODIFIES: cout
